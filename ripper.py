...
print "\t 3: audio from all videos by a YouTube user/channel"
print "\t 4: audio from all videos in a playlist"
print ""
print "***WARNING: THIS SCRIPT WILL ERASE *ALL* .M4A FILES IN THIS DIRECTORY AFTER RUNNING***"
print ""
...
if choice == 1: 
	...
	link = raw_input()
	subprocess.call("youtube-dl " + link + " -itw --extract-audio --audio-format mp3 --audio-quality 0 --add-metadata", shell=True)
	subprocess.call("rm *.m4a", shell=True)
	print "Ripped!"

if choice == 2: 
	print "Enter the name of the text file (e.g. links.txt): "
	links = raw_input()
	subprocess.call("youtube-dl -itw --extract-audio --audio-format mp3 --audio-quality 0 --add-metadata -a, --batch-file " + links, shell=True)
	subprocess.call("rm *.m4a", shell=True)
	print "Ripped!"
...
if choice == 3: 
	...
	user = raw_input()
	subprocess.call("youtube-dl -itw ytuser:" + user + " --extract-audio --audio-format mp3 --audio-quality 0 --add-metadata", shell=True)
	subprocess.call("rm *.m4a", shell=True)
	print "Ripped!"
...
if choice == 4: 
	...
	playlist = raw_input()
	subprocess.call("youtube-dl " + playlist + " -itw --extract-audio --audio-format mp3 --audio-quality 0 --add-metadata", shell=True)
	subprocess.call("rm *.m4a", shell=True)
	print "Ripped!"
